...
export default function SuperAdminOverview() {
      ...
      .catch((err: unknown) => {
        ...
        const message =
          ...
          (err as { code?: string }).code === 'ERR_NETWORK'
            ? 'Cannot reach the API. Start python_backend: uvicorn main:app --host 0.0.0.0 --port 8000 --reload'
  ...
  // Fetch visitor trends when period changes
  useEffect(() => {
    AnalyticsService.getVisitorTrends(trendPeriod)
