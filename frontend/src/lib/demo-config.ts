...
export const DEMO_PERSONAS: DemoPersona[] = [
  ...
  },
  {
    ...
    departmentId: null,
    subDepartmentId: null,
    hospitalChainName: 'Connitor Health Network',
    branchName: 'Connitor Hospital (Electronic City)',
    hospitalChain: { name: 'Connitor Health Network' },
    branch: { name: 'Connitor Hospital (Electronic City)' },
  },
  {
