...
export const seedUsers: MockUser[] = [
  ...
  {
    id: USER_IDS.CHAIN_ADMIN_APOLLO_1,
    name: 'Rajesh Kumar',
    phone: '8482022111',
...
export function buildSeedVisits(): MockVisit[] {
  return [
    ...
    },
    {
      ...
      purpose: 'Visit patient in Room 101',
      department: 'CARDIOLOGY',
      visitCode: '481256',
      checkInOtp: '654321',
      checkInOtpExpiry: hoursAgo(-1),
    ...
    },
    {
      ...
      purpose: 'Operational audit meeting',
...
export function buildSeedNotifications(): MockNotification[] {
  return [
    ...
    },
    {
      ...
      recipientId: USER_IDS.CHAIN_ADMIN_APOLLO_1,
