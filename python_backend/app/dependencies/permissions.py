...
ROLE_PERMISSION_DEFAULTS: dict[str, set[str]] = {
    ...
    "HOSPITAL_ADMIN": {
        ...
        "VIEW_WALLET", "VIEW_ATTENDANT_PASS", "MANAGE_ATTENDANT_PASS",
    },
    "BRANCH_ADMIN": {
        "VIEW_DELIVERY", "VIEW_VENDOR", "APPROVE_VENDOR", "VIEW_SECURITY_DASHBOARD",
        "VIEW_RECEIVING", "VIEW_ATTENDANT_PASS",
    },
    "SECURITY": {
    ...
    "DISTRIBUTOR": {"VIEW_DELIVERY", "CREATE_DELIVERY", "VIEW_WALLET", "CREATE_PAYMENT"},
